...
public partial class @PlayerInputAssets: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""processors"": """",
                    ""interactions"": ""Hold(duration=0.1,pressPoint=0.35)"",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Attack"",
    ...
    ~@PlayerInputAssets()
    {
        UnityEngine.Debug.Assert(!m_PlayerInputMap.enabled, "This will cause a leak and performance issues, PlayerInputAssets.PlayerInputMap.Disable() has not been called.");
    }
