...
namespace Editor
{
    ...
    {  
        ...
        static void SetAssetBundleForAllPrefabsInHotResources()
        {
            ...
            // 获取目标文件夹及其子文件夹下的所有预制体  
            // string[] strsAllPrefabs = Directory.GetFiles(targetRootFolder, "*.prefab", SearchOption.AllDirectories); 
            ...
            foreach (string prefabPath in strsAllPrefabs)  
            {  
                // 获取资源的Importer  
        ...
        {  
            ...
            // 将路径中的反斜杠(Windows为\，Linux中为/)替换为下划线，并转换为小写  
